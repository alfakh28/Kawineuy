      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto shadow-lg border border-white/40">
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-2xl font-serif text-gray-700 italic mb-4">
              {t('couple.love-quote')}
            </p>
            <p className="text-gray-500 text-xs sm:text-sm">— QS. Ar-Rum : 21</p>
          </div>
        </motion.div>
      </div>
    </div>
